...
export default function CtaBand() {
  return (
    <section className="my-12 overflow-hidden bg-green lg:my-16">
      <div className="container-page flex flex-col items-stretch gap-6 py-9 sm:py-10 md:flex-row md:items-center md:justify-between md:gap-8 md:py-11">
        <div data-reveal="left" className="flex min-w-0 items-center gap-3.5 sm:gap-4">
        ...
        <ContactButton data-reveal="right" className="inline-flex shrink-0 items-center justify-center rounded-md bg-gold px-7 py-3.5 text-center text-[13.5px] font-medium text-white transition-colors hover:bg-gold-dark max-w-[420px] sm:text-[14.5px] md:max-w-none md:self-auto">
          Get in Touch Today
        </ContactButton>
      </div>
    </section>
