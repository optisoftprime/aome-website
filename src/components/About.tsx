...
export default function About() {
  return (
    <section id="about" className="relative bg-green">
      <div className="grid w-full items-center lg:grid-cols-[1.05fr_1fr]">
        <div className="lg-inset-left-wide px-[calc(var(--page-gutter)+var(--page-gutter-extra))] py-16 lg:py-24 lg:pr-14">
          <h2 className="text-[2.2rem] font-semibold tracking-[-0.02em] text-white sm:text-[2.75rem] lg:text-[3rem]">
            About Us
          </h2>
          <p className="mt-6 max-w-[62ch] text-[15px] leading-[2] text-white/85 sm:text-[15.5px]">
        ...
        <div className="relative h-[300px] sm:h-[380px] lg:h-full lg:min-h-[400px]">
